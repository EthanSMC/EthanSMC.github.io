...
const messages = {
  zh: {
    ...
    "writing.albumStatusLabel": "状态",
    "writing.albumStatusOngoing": "连载中",
    "writing.albumTracks": "目录",
    ...
    "blog.post.next": "下一篇",
    "blog.post.back": "返回写作",
    "blog.reader.aria": "阅读辅助导航",
    "blog.reader.progress": "阅读进度",
    "blog.reader.contents": "目录",
    "blog.reader.contentsTitle": "本文目录",
    "blog.reader.closeContents": "关闭目录",
    "blog.reader.currentSection": "当前章节",
  ...
  ja: {
    ...
    "writing.albumStatusLabel": "ステータス",
    "writing.albumStatusOngoing": "連載中",
    "writing.albumTracks": "目次",
    ...
    "blog.reader.aria": "読書ナビゲーション",
    "blog.reader.progress": "読書進捗",
    "blog.reader.contents": "目次",
    "blog.reader.contentsTitle": "この記事の目次",
    "blog.reader.closeContents": "目次を閉じる",
    "blog.reader.currentSection": "現在のセクション",
  ...
  en: {
    ...
    "writing.albumStatusLabel": "Status",
    "writing.albumStatusOngoing": "Ongoing",
    "writing.albumTracks": "Contents",
    ...
    "blog.reader.aria": "Reading navigation",
    "blog.reader.progress": "Reading progress",
    "blog.reader.contents": "Contents",
    "blog.reader.contentsTitle": "In this piece",
    "blog.reader.closeContents": "Close contents",
    "blog.reader.currentSection": "Current section",
